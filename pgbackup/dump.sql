...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: cloud_user
--
...
ALTER TABLE public.employees OWNER TO cloud_user;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: cloud_user
--
